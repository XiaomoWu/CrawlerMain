...
class SinaNewsSpider(Spider):
    ...
    def start_requests(self):
        start_url = "http://roll.news.sina.com.cn/interface/rollnews_ch_out_interface.php?col=97,98,99&num=100000&date="    
        start_date = datetime.strptime("2017-09-28", "%Y-%m-%d").date()
        end_date = datetime.strptime("2017-09-28", "%Y-%m-%d").date()
        url_date = []
